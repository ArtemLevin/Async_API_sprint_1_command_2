...
from api.v1.genres import router as genres_router  # Исправлено для жанров
...
async def startup():
    ...
    try:
        ...
        await redis.redis.ping()  # Проверяем доступность Redis
...
app.include_router(genres_router, prefix="/api/v1/genres", tags=["genres"])  # Исправлено для жанров